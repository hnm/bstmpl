...
<section>
	...
	<div class="row form-row">
		<?php foreach ($colors as $color): ?>
			<div class="<?php $html->out($baseColClass) ?>">
				<div class="<?php $html->out($baseBoxClass) ?> <?php $html->out($colorsPrefix) ?><?php $html->out($color) ?>"><?php $html->out($color) ?></div>
			</div>
		<?php endforeach ?>
	</div>
	...
	<div class="row form-row">
		<?php foreach ($themeColors as $themeColor): ?>
			<div class="<?php $html->out($baseColClass) ?>">
				<div class="<?php $html->out($baseBoxClass) ?> <?php $html->out($colorsPrefix) ?><?php $html->out($themeColor) ?>"><?php $html->out($themeColor) ?></div>
			</div>
		<?php endforeach ?>
	</div>
	<h3 class="mt-4">Project Theme Colors</h3>
	<?php foreach ($projectThemeColors as $key => $projectThemeColor): ?>
		<div class="row form-row">
			<?php foreach($projectThemeColors[$key] as $themeVariant): ?>
				<div class="col">
				<div class="<?php $html->out($baseBoxClass) ?> <?php $html->out($colorsPrefix) ?><?php $html->out($themeVariant) ?>"><?php $html->out($themeVariant) ?></div>
			</div>
			<?php endforeach ?>
		</div>
	<?php endforeach ?>
	...
	<div class="row form-row">
		<?php foreach ($grays as $gray): ?>
			<div class="col">
				<div class="<?php $html->out($baseBoxClass) ?> <?php $html->out($colorsPrefix) ?><?php $html->out($gray) ?>"><?php $html->out($gray) ?></div>
			</div>
		<?php endforeach ?>
	</div>

	<h3 class="mt-4">Project Gray Colors</h3>
	<div class="row form-row">
		<?php foreach ($projectGrays as $gray): ?>
			<div class="col">
				<div class="<?php $html->out($baseBoxClass) ?> <?php $html->out($colorsPrefix) ?><?php $html->out($gray) ?>"><?php $html->out($gray) ?></div>
			</div>
		<?php endforeach ?>
