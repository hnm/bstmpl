...
<section>
	...
	<div class="row">
		<div class="col-sm-1">
			<div class="brand-danger-bg range-f-fg">Danger / Error</div>
		</div>
		<div class="col-sm-1">
			<div class="brand-warning-bg range-f-fg">Warning</div>
		</div>
		<div class="col-sm-1">
			<div class="brand-success-bg range-f-fg">Success</div>
		</div>
		<div class="col-sm-1">
			<div class="brand-info-bg range-f-fg">Info</div>
		</div>
		<div class="col-sm-1">
			<div class="brand-primary-bg range-f-fg">Primary</div>
		</div>
		<div class="col-sm-1">
			<div class="brand-secondary-bg range-f-fg">Secondary</div>
		</div>
		<div class="col-sm-1">
			<div class="range-0-bg range-f-fg">Background</div>
		</div>
		<div class="col-sm-1">
			<div class="range-1-bg range-f-fg">Range 1</div>
		</div>
		<div class="col-sm-1">
			<div class="range-2-bg range-f-fg">Range 2</div>
		</div>
		<div class="col-sm-1">
			<div class="range-3-bg range-f-fg">Range 3</div>
		</div>
		<div class="col-sm-1">
			<div class="range-4-bg range-f-fg">Range 4</div>
		</div>
		<div class="col-sm-1">
			<div class="range-5-bg range-f-fg">Range 5</div>
		</div>
		
	</div>
	<div class="row">
		<div class="col-sm-1">
			<div class="range-6-bg range-f-fg">Range 6</div>
		</div>
		<div class="col-sm-1">
			<div class="range-7-bg range-f-fg">Range 7</div>
		</div>
		<div class="col-sm-1">
			<div class="range-8-bg range-0-fg">Range 8</div>
		</div>
		<div class="col-sm-1">
			<div class="range-9-bg range-0-fg">Range 9</div>
		</div>
		<div class="col-sm-1">
			<div class="range-a-bg range-0-fg">Range A</div>
		</div>
		<div class="col-sm-1">
			<div class="range-b-bg range-0-fg">Range B</div>
		</div>
		<div class="col-sm-1">
			<div class="range-c-bg range-0-fg">Range C</div>
		</div>
		<div class="col-sm-1">
			<div class="range-d-bg range-0-fg">Range D</div>
		</div>
		<div class="col-sm-1">
			<div class="range-e-bg range-0-fg">Range E</div>
		</div>
		<div class="col-sm-1">
			<div class="range-f-bg range-0-fg">Range F</div>
		</div>
...
<section>
	...
	<div class="row">
		<div class="col-sm-4 col-sm-half-6">
			<h3>Differences to Twitter Bootstrap</h3>
		...
		<div class="col-sm-4 col-sm-full-6 col-sm-full-2">
	...
	<div class="row">
		<h2 class="col-sm-12">Blockquotes</h2>
		
		<div class="col-sm-6 col-sm-half-6">
			<blockquote>
		...
		<div class="col-sm-6 col-sm-half-6">
			<blockquote class="pull-right">
				<p>You can use blockquote also with the <code>pull-right</code> class.</p>
				<small>Twitter</small>
			</blockquote>
		</div>
	</div>
